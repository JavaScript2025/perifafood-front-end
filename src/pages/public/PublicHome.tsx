...
export default function PublicHome() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#FFFBFF] to-[#F9F5FF]">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-2xl text-center lg:text-left">
                  A plataforma de delivery que nasceu nas quebradas e
                  revoluciona como a comunidade consome e empreende.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Veja o que restaurantes e clientes estão falando sobre a
              experiência PerifaFood
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center">
                  <div
                    className={`w-20 h-20 ${item.bg} rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm`}
                  >
            ...
            {[
              {
                step: "01",
                title: "Cadastro",
                desc: "Restaurante se cadastra",
                color: "bg-[#F22738]",
              },
              {
                step: "02",
                title: "Cardápio",
                desc: "Adiciona os pratos",
                color: "bg-[#F2B23A]",
              },
              {
                step: "03",
                title: "Pedidos",
                desc: "Clientes fazem pedidos",
                color: "bg-[#F22738]",
              },
              {
                step: "04",
                title: "Entrega",
                desc: "Entregador local busca",
                color: "bg-[#F2B23A]",
              },
              {
                step: "05",
                title: "Sucesso",
                desc: "Todo mundo ganha",
                color: "bg-[#F22738]",
              },
            ].map((item, index) => (
              <div key={index} className="text-center flex-1 group">
                <div
                  className={`w-20 h-20 ${item.color} rounded-full flex items-center justify-center mx-auto mb-4 transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
      ...
      <section className="py-20 bg-white" id="ajuda">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-[#F22738] to-[#F2B23A] rounded-3xl p-12 text-center shadow-2xl relative">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto relative z-10">
              Milhares de restaurantes e clientes já fazem parte. Chegou sua
              hora de transformar o delivery na sua comunidade.
            </p>
