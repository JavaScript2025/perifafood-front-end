const Botao = ({ children, variant = "laranja", className = "", ...props }) => {
  ...
  if (variant === "laranja") {
    ...
    classes =
      "px-5 py-3 rounded-full font-semibold text-white bg-red-800 hover:bg-red-700 cursor-pointer";
  } else if (variant === "azul") {
    classes = "px-5 py-3 bg-blue-400 font-semibold text-white rounded-full hover:bg-blue-800 cursor-pointer";
